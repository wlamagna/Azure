## This project is an Azure Container instance with a snake game.  It is in progress, the game was just vibe coded but it is nice, i found interesting putting it in a container and publishing it.  It is in progress.
